(function () {
  ...
  var COPY = {
    bn: {
      ...
      aboutBody: 'উত্তরপাড়া, হিন্দমোটর, বেলুর, শ্রীরামপুর ও আশপাশের এলাকা থেকে প্রায় ১,৫০০ শিক্ষার্থী এখানে পড়াশোনা করে। ঋতমা Academy এই বিদ্যালয়ের শিক্ষার্থীদের একটি TruthGuard-ভিত্তিক পশ্চিমবঙ্গ বোর্ড শিক্ষা প্রচেষ্টা।',
    ...
    en: {
      ...
      aboutBody: 'Around 1,500 students from Uttarpara, Hindmotor, Bally, Belur, Srirampur, and nearby towns study here. Rhytoma Academy is a student-led TruthGuard West Bengal Board education initiative from this school.',
      wikiLink: 'Wikipedia →',
