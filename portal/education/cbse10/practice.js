    ...
    function render() {
      ...
      if (isMcq) {
        ...
        const hintHtml = hint
          ...
          : '';
        resp.innerHTML = `
          <div class="answer-hint" style="font-size:0.78rem;color:#94a3b8;margin-bottom:8px">
            Use the symbol bar for math/science notation · draw a diagram or upload an image if needed
          </div>
